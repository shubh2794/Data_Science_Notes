...
const nodes = [
  ...
  {id:"Regression & Correlation", group:"math", level:3, desc:"The inferential view of the fitted line: correlation and its traps, the regression effect and the fallacy named after it, inference on the slope, residual diagnostics, prediction vs confidence bands, extrapolation, and why r² is not a licence to claim causation."},
  {id:"Resampling (Bootstrap & Permutation)", group:"math", level:3, desc:"Replacing distributional assumptions with computation: the bootstrap for standard errors and intervals, permutation tests for comparing groups, when resampling works and when it fails, and the connection to cross-validation."},
  {id:"Categorical Data & Chi-Square", group:"math", level:3, desc:"Counts rather than measurements: two-way tables, conditional distributions, the chi-square tests of goodness-of-fit and independence, expected counts and residuals, odds ratios and relative risk, and Simpson's paradox."},
