...
const GROUPS = {
  ...
  db:    {label:"Databases", short:"Databases", color:"#818cf8"},
  big:   {label:"Big Data", short:"Big Data", color:"#facc15"},
  sysd:  {label:"System Design", short:"Sys Design", color:"#94a3b8"},
...
const nodes = [
  ...
  {id:"Computer Vision", group:"cv", level:1, desc:"Enabling machines to interpret and reason about images and video."},
  ...
  {id:"Statistics", group:"math", level:2, desc:"Inference, hypothesis testing, confidence intervals, and sampling from data."},
  {id:"Calculus", group:"math", level:2, desc:"Derivatives and gradients — the engine behind optimization and backpropagation."},
  ...
  {id:"Databases", group:"db", level:1, desc:"Storing and querying data: relational/SQL, NoSQL, indexing, transactions (ACID), and scaling (sharding/replication)."},
  {id:"Big Data", group:"big", level:1, desc:"Processing data at scale: distributed compute (Spark/MapReduce), streaming, and data lakes/warehouses."},
  {id:"System Design", group:"sysd", level:1, desc:"Designing scalable systems: load balancing, caching, message queues, microservices, and CAP trade-offs."},
  ...
  {id:"Relational & SQL", group:"db", level:2, desc:"Tables, keys, joins, and the SQL query language over normalized relational schemas."},
  {id:"NoSQL", group:"db", level:2, desc:"Non-relational stores — key-value, document, columnar, graph — for scale and flexibility."},
  {id:"Indexing", group:"db", level:2, desc:"Data structures (B-trees, hashes) that make lookups fast at some write/space cost."},
  {id:"Transactions (ACID)", group:"db", level:2, desc:"Atomicity, consistency, isolation, durability — guarantees for correct concurrent writes."},
  {id:"Sharding & Replication", group:"db", level:2, desc:"Partitioning data across machines and copying it for scale and availability."},
  {id:"Hadoop & MapReduce", group:"big", level:2, desc:"The batch paradigm that started big data: distribute work as map and reduce steps over a cluster."},
  {id:"Streaming (Kafka)", group:"big", level:2, desc:"Processing unbounded event streams in near-real-time; Kafka as the durable log."},
  {id:"Data Lakes", group:"big", level:2, desc:"Store raw data at scale in open formats, schema-on-read, for flexible downstream use."},
  {id:"Distributed Storage", group:"big", level:2, desc:"Spreading data across nodes (HDFS, object stores) for capacity and fault tolerance."},
  {id:"Warehouses & Lakehouses", group:"big", level:2, desc:"Structured analytical stores and the lakehouse blend of lake flexibility + warehouse speed."},
  {id:"Scalability", group:"sysd", level:2, desc:"Handling growth by scaling up (bigger) or out (more machines); statelessness and partitioning."},
  {id:"Load Balancing", group:"sysd", level:2, desc:"Distributing requests across servers for throughput and resilience."},
  {id:"Caching", group:"sysd", level:2, desc:"Storing hot results closer to compute to cut latency and load (CDN, Redis, app cache)."},
  {id:"Message Queues", group:"sysd", level:2, desc:"Decoupling producers and consumers with async queues (Kafka, RabbitMQ, SQS)."},
  {id:"CAP Theorem", group:"sysd", level:2, desc:"Under partition, choose consistency or availability — the core distributed-systems trade-off."},
  ...
  // Viz
  {id:"Exploratory Data Analysis", group:"viz", level:2, desc:"First-pass investigation — distributions, correlations, outliers — before modeling."},
...
const tree = {
  ...
  "Databases":["Relational & SQL","NoSQL","Indexing","Transactions (ACID)","Sharding & Replication"],
  "Big Data":["Hadoop & MapReduce","Streaming (Kafka)","Data Lakes","Distributed Storage","Warehouses & Lakehouses"],
  "System Design":["Scalability","Load Balancing","Caching","Message Queues","CAP Theorem"],
  "Data Engineering":["ETL Pipelines","Data Warehousing","Feature Stores","Stream Processing","Data Preprocessing","Data Sampling & Imbalance","Data Quality & Governance","Differential Privacy","Vector Databases (HNSW)"],
  ...
  "Data Viz & Communication":["Exploratory Data Analysis","Dashboards","Data Storytelling"],
...
const cross = [
  ...
  ["SQL","Data Engineering"],["Data Structures & Algorithms","Machine Learning"],["Databases","Data Engineering"],
  ["Apache Spark","Big Data"],["Big Data","Data Engineering"],["Big Data","Distributed Training"],
  ["System Design","MLOps & Deployment"],["System Design","Distributed Training"],["System Design","LLMOps"],
  ...
  ["Calculus","Optimization"],["Linear Algebra","Optimization"],["Probability","Naive Bayes"],
  ...
  ["SQL","Data Warehousing"],["SQL","Exploratory Data Analysis"],["SQL","Apache Spark"],["SQL","ETL Pipelines"],["Apache Spark","Stream Processing"],
  ...
  ["Exploratory Data Analysis","Statistics"],["Exploratory Data Analysis","Pandas & NumPy"],["Dashboards","Monitoring & Drift"],
  ...
  ["GPT","Large Language Models"],["GPT","Transformers"],["GPT","Encoder vs Decoder Models"],["GPT","BERT"],["GPT","Policy / Preference Optimization"],["GPT","Attention"],
  ["CLIP","Vision-Language Models"],["CLIP","Embeddings"],["CLIP","Diffusion Models"],["CLIP","Transformers"],
  ["LayoutLM","Document Intelligence"],["LayoutLM","BERT"],["LayoutLM","Transformers"],["LayoutLM","Donut"],["LayoutLM","Vision Transformers"],
  ...
  ["Pandas","SQL"],["Pandas","Data Preprocessing"],["Pandas","Exploratory Data Analysis"],["Pandas","Apache Spark"],
